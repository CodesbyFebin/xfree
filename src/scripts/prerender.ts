...
const STATIC_META: Record<string, { title: string; description: string; h1: string; intro: string }> = {
  ...
  "/trust": { title: "Trust & Security — XFree.in", description: "XFree.in security posture: CSP, rate limits, secret handling, and abuse controls on AI endpoints.", h1: "Trust & Security", intro: "How we harden the platform against abuse and protect your data." },
