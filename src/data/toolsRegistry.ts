...
const HAND_CRAFTED_TOOLS: ToolDefinition[] = [
  {
    ...
    status: "published",
    indexable: true,
    engineVerified: true,    lastModified: "2026-03-15",
    isFlagship: true,
  ...
  },
  {
    ...
    status: "published",
    indexable: true,
    engineVerified: true,    lastModified: "2026-08-29",
    ...
    faqs: [
      { question: "What formula does the SIP calculator use?", answer: "The standard future value of an annuity due: M = P × [(((1+i)^n − 1) / i) × (1+i)], where P is the monthly investment, i is the monthly rate (annual rate ÷ 12 ÷ 100), and n is the number of months. This is the same formula used by AMFI-registered mutual fund calculators and most bank SIP tools. It assumes a constant monthly return, which real markets don't deliver — actual returns will vary." },
