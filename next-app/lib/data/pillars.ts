...
const SECURITY_PILLARS: PillarDefinition[] = [
  { slug: "hash-generator-tools", num: "26", name: "Hash Generator Tools Hub", description: "Generate hashes: MD5, SHA-1, SHA-256, SHA-512, bcrypt, Argon2, scrypt, Whirlpool, RIPEMD, xxHash, CRC32, BLAKE2, Blake3", icon: "#️⃣", color: "red", category: "security", toolCount: 15, keywords: ["hash generator", "sha256", "md5", "bcrypt"] },
  { slug: "password-tools", num: "27", name: "Password Generator & Manager Tools Hub", description: "Password security: generator, strength checker, hash extractor, breach checker (HIBP), passphrase generator, password规律的器", icon: "🔑", color: "red", category: "security", toolCount: 12, keywords: ["password generator", "password strength", "passphrase", "hibp checker"] },
